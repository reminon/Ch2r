...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'sizeTextBox
    '
    Me.sizeTextBox.Location = New System.Drawing.Point(232, 4)
    ...
    'partsTextBox
    '
    Me.partsTextBox.Location = New System.Drawing.Point(64, 4)
    ...
    Me.extractButton.Location = New System.Drawing.Point(8, 224)
    ...
    'formatTextBox
    '
    Me.formatTextBox.Location = New System.Drawing.Point(392, 4)
    ...
    Me.imagesGroupBox.Size = New System.Drawing.Size(480, 272)
    ...
    Me.imagesListBox.Size = New System.Drawing.Size(278, 251)
    ...
    Me.previewPanel.Controls.Add(Me.extractButton)
    Me.previewPanel.Controls.Add(Me.injectButton)
    Me.previewPanel.Dock = System.Windows.Forms.DockStyle.Right
    Me.previewPanel.Location = New System.Drawing.Point(281, 16)
    Me.previewPanel.Name = "previewPanel"
    Me.previewPanel.Size = New System.Drawing.Size(196, 253)
    Me.previewPanel.TabIndex = 15
    '
    'previewLabel
    '
    Me.previewLabel.Dock = System.Windows.Forms.DockStyle.Top
    Me.previewLabel.Location = New System.Drawing.Point(0, 196)
    Me.previewLabel.Name = "previewLabel"
    Me.previewLabel.Size = New System.Drawing.Size(196, 20)
    ...
    Me.previewPictureBox.Size = New System.Drawing.Size(196, 196)
    ...
    Me.panel.Location = New System.Drawing.Point(0, 272)
    Me.panel.Name = "panel"
    Me.panel.Size = New System.Drawing.Size(480, 32)
    ...
    Me.injectButton.Location = New System.Drawing.Point(104, 224)
...
#End Region
  ...
  Private Sub ExtractCurrent()
    ' Filename
    Dim idx As Integer = imagesListBox.SelectedIndex
    Dim path As String = _filename.Substring(_filename.LastIndexOf("\") + 1) + "." + idx.ToString
    Dim format As String = BitmapFormat(idx).Replace("/", "").ToLower
    If format.StartsWith("dxt") Then
      path += "." + format
    End If
    bitmapSaveFileDialog.FileName = path + ".dds"

    If bitmapSaveFileDialog.ShowDialog = System.Windows.Forms.DialogResult.OK Then
  ...
  Private Sub InjectCurrent()
    ' Filename
    If bitmapOpenFileDialog.ShowDialog = System.Windows.Forms.DialogResult.OK Then
  ...
  Public Function BitmapWidth(ByVal index As Integer) As Short
    Return bitmheader._items(index).Width
  End Function

  Public Function BitmapHeight(ByVal index As Integer) As Short
    Return bitmheader._items(index).Height
  End Function

  Public Function BitmapFormat(ByVal index As Integer) As String
    Return ImageType(bitmheader._items(index).Format)
  End Function

  Public Function BitmapLocation(ByVal index As Integer) As String
  ...
  Public Function BitmapCount() As Integer
    Return bitmheader.Count
  End Function

  Public Function ShowPreview(ByVal index As Integer) As Integer
    ...
    Try
      ...
      Select Case bitmheader._items(index).Format
        ...
        Case bitmEnum.BITM_FORMAT_A4R4G4B4
          Try
            decodedChunk = SwizzlePicture(bChunk, width, height, -1, 16, SwizzleType.DeSwizzle)
          Catch
            bError = True
            decodedChunk = bChunk
          End Try
