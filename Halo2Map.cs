...
namespace Ch2r
{
	...
	public class Map
	{
		...
		#region Tags
		static string[][] tags = { // Thx to D3fault_dot_Xbe
	...
	public class SoundIndex
	{
		...
		public void ReadSoundList(MapIndexItem ugh, FileStream fs, uint secMagic)
		{
			try 
			{
				...
				// Read sound options
				Reflexive optionReflex = new Reflexive();
				...
				// Read sound pieces
				Reflexive piecesReflex = new Reflexive();
				...
				// Read sound pointers
				Reflexive pointersReflex = new Reflexive();
				...
				for (int i = 0; i < pointersReflex.Count; i++)
				{
					...
					soundPointers[i].size = br.ReadUInt32();
